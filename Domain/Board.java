...
public class Board implements Serializable {
    ...
    /**
     * Crea un bloque de hielo en la dirección del helado
     */
    public boolean createIceBlock() {
        ...
        Position icePos = iceCream.createIceBlock();
        if (icePos != null && isValidPosition(icePos)) {
            IceBlock newBlock = new IceBlock(icePos, true, iceCream);
