 ...
 * Solo puede recolectarse si NO tiene púas. Cada ciclo de púas es de 30 segundos.
 */
public class Cactus extends Fruit {
    ...
    private boolean spiky;                 // ¿Tiene púas actualmente?
    private long lastStateChange;           // Último cambio de estado púas
