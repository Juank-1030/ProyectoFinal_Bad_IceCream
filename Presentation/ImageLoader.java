 ...
 * 
 * RESPONSABILIDADES:
 * - Cargar y cachear todas las imágenes del juego (sprites de helados, monstruos, frutas, hielo, mapas)
...
public class ImageLoader {
     ...
     * @param direction Dirección: "down", "up", "left", "right" (solo para stand, walk, break, shoot)
     ...
     * 
     * @param type  Tipo de fruta: "cherry", "banana", "grapes", "pineapple", "cactus"
